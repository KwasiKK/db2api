<?php
    ...
    array_push($new_content, "\t\t\treturn Redirect::to('".$table."/'.\$id.'/edit')\n");
    ...
    array_push($new_content, "\t\t\t$".$table." = ".$table."::find(\$id); \n");
   ...
   //merge $column_rules into $new_content
    ...
    array_push($new_content, "\t\t\tSession::flash('message', 'Successfully updated ".$table."!');\n");
